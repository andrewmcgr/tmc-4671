...
* `impedance_current_fraction` (optional, default 0.2): fraction of `run_current` used as the target current during impedance measurement. Adjust if the motor's current profile requires a different measurement current.
